...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LIGHT Protocol Genesis — Civilization Operating System" },
      { name: "description", content: "Browser-native civilization operating system. Modular scanner-driven runtime for spaceflight, industry, research and AI." },
      { property: "og:title", content: "LIGHT Protocol Genesis" },
      { property: "og:description", content: "A browser-native civilization operating system built on a procedural scanner engine." },
